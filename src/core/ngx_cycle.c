...
ngx_init_cycle(ngx_cycle_t *old_cycle)
{
    ...
    /*
     * 6个核心模块(ngx_core_module、ngx_errlog_module、ngx_events_module、ngx_openssl_module、ngx_http_module、ngx_mail_module)中，
     * 只有 ngx_core_module 和 ngx_openssl_module 存在create_conf回调函数，分别对两个模块创建数据结构
     */
